...
function ReportCommunityModal({isOpen, onClose, typeID, REPORT_TYPE}:IProps) {
            ...
            <ModalBody width='100%' height='100%' paddingX='20px' overflow={'hidden'} paddingY='20px'>
              ...
              <Flex width={'100%'} flexDirection={'column'} justifyContent={'center'} alignItems={'center'}>
                <HStack justifyContent={'space-between'} alignItems={'center'} width={'100%'}>
                        ...
                        <CustomText color='brand.chasescrollButtonBlue' fontFamily={'Satoshi-Medium'}>Report Community</CustomText>
