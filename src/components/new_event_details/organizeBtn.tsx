        ...
        <Box my={"auto"} w={"full"} >
            ...
            <ModalLayout open={open} close={setOpen} title='' >
                <Box px={"4"} pt={"5"} pb={"5"} >
                    ...
                    <Text fontWeight={"medium"} textAlign={"center"} >You can only edit the date, time, location of this event, and increase number of available ticket because people have already bought tickets to this event.</Text>
