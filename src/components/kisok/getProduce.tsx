            ...
            <Grid templateColumns={["repeat(2, 1fr)", "repeat(2, 1fr)", "repeat(3, 1fr)", "repeat(3, 1fr)"]} gap={["4", "4", "6"]} >
                {results?.map((item: IProduct, index: number) => {
                    if (results?.length === index + 1) {
                        return (
                            <Flex ref={ref} as={"button"} alignItems={"start"} onClick={() => clickHandler(item)} key={index} p={["0px", "0px", "4"]} borderWidth={"1px"} borderColor={borderColor} w={"full"} h={"fit-content"} flexDir={"column"} bgColor={"white"} rounded={"16px"} pb={"5"} gap={"4"} >
                                ...
                                <Flex w={"full"} h={"210px"} borderWidth={"1px"} justifyContent={"center"}  rounded={"8px"} >
                                ...
                                <Flex w={"full"} h={"fit-content"} flexDir={"column"} gap={2} px={"2"} >
                                    <Text fontSize={["14px", "14px","24px"]} fontWeight={"600"} textAlign={"left"} >{capitalizeFLetter(item?.name)}</Text>
                                    ...
                                    <Flex w={"full"} gap={"2"} alignItems={"center"} >
                                        <LocationStroke />
                                        <Text fontSize={["10px", "14px", "14px"]} fontWeight={"500"} color={bodyTextColor} >{textLimit(item?.location?.locationDetails, 14)}</Text>
                                    </Flex>
                        ...
                        return (
                            <Flex as={"button"} alignItems="start" onClick={() => clickHandler(item)} key={index} p={["0px", "0px", "4"]} borderWidth={"1px"} borderColor={borderColor} w={"full"} h={"fit-content"} flexDir={"column"} bgColor={"white"} rounded={"16px"} pb={"5"} gap={"4"} >
                                <Flex w={"full"} h={"full"} alignItems={"center"} gap={2} >
                                    <UserImage image={item?.createdBy?.data?.imgMain?.value} font={"16px"} data={item?.createdBy} border={"1px"} size={"32px"} />
                                    <Flex flexDir={"column"} alignItems={"start"} >
                                        <Text fontSize={"12px"} fontWeight={"600"} color={primaryColor} >
                                ...
                                <Flex w={"full"} h={"210px"} justifyContent={"center"} rounded={"8px"} >
