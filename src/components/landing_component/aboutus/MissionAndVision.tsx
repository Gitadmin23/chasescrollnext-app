    ...
    return(
        <Flex w={"full"} px={["6", "6", "12"]} py={["10", "10", "20"]} flexDir={["column", "column", "row"]} gap={"8"} bgColor={"#FCFCFCF5"} >
            <Flex w={"full"} h={[ "auto", "auto", "439px"]} py={"8"} gap={"2"} justifyContent={"center"} shadow={"lg"} rounded={"xl"} px={"8"} flexDir={"column"} >
                ...
                <Text fontSize={["16px", "16px", "lg"]} lineHeight={"21.78px"} mt={"4"} color={"#222222CC"} >At ChaseScroll, we value the power of connection and community. Our mission is to facilitatemeaningful connections among event organisers, participants, and attendees.</Text>
            </Flex>
            <Flex w={"full"} h={[ "auto", "auto", "439px"]} py={"8"} gap={"2"} justifyContent={"center"} shadow={"lg"} rounded={"xl"} px={"8"} flexDir={"column"} >
