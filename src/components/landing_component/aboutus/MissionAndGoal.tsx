...
function MissionAndGoal(){
    return(
        <Flex w={"full"} px={["6", "6", "12"]} py={["10", "10", "20"]} flexDir={"column"} gap={"6"} >
            ...
            <Text fontSize={["12px", "12px", "19.53px"]} lineHeight={["17.15px", "17.15px", "28px"]} >Chasescroll is a cutting-edge event management platform designed to streamline the process of organizing and participating in events.</Text>
        </Flex>
    )
}
