...
function MissionAndGoal(){
    return(
        <Flex w={"full"} px={["6", "6", "12"]} py={["10", "10", "20"]} flexDir={"column"} gap={"6"} >
            ...
            <Text lineHeight={["22px", "22px", "54.46px"]} fontSize={["16px", "16px", "45px"]} >Chasescroll is a cutting-edge event management platform designed to streamline the process of organizing and participating in events.</Text>
        </Flex>
    )
}
