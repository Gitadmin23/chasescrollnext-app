    ...
    return(
        <Flex w={"full"} display={["none", "none", "flex"]} alignItems={"center"} h={"547px"} px={"12"} pos={"relative"} >
            ...
            <Flex w={"full"} flexDir={"column"} zIndex={"20"} gap={"6"} color={"white"} >
                ...
                <CustomButton onClick={() => router.push("/auth")} text={"Get Started"} width={"152px"} backgroundColor={THEME?.COLORS?.chasescrollButtonBlue} height={"48px"} borderWidth={"1px"} borderColor={THEME?.COLORS?.chasescrollBlue} color={"white"} borderRadius={"8px"} />
            </Flex>
