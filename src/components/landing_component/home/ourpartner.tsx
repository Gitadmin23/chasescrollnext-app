    ...
    return (
        <Flex w={"full"} flexDir={"column"} >
            <Flex borderBottomWidth={"1px"} borderColor={"#CDD3FD"} width={"full"} alignItems={"center"} flexDir={"column"} gap={"6"} justifyContent={"center"} height={"267px"} >
                ...
                <Flex w={"fit-content"} gap={"12"} alignItems={"center"} >
            ...
            <Flex width={"full"} alignItems={"center"} flexDir={"column"} gap={"6"} justifyContent={"center"} height={"345px"} >
                <Text maxW={"913px"} fontSize={"45px"} lineHeight={"54.46px"} textAlign={"center"} fontWeight={"semibold"} >Let <span style={{ color: THEME?.COLORS?.chasescrollBlue }} >Chasescroll</span> Power your Event with our Amazing features</Text>
            </Flex>
        </Flex>
    )
}