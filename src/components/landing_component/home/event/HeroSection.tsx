...
export default function HeroSection() {
    ...
    return ( 
        <Flex w={"full"} h={["auto", "fit-content", "100vh"]} color={"white"} pos={"relative"} >
            ...
            <Image pos={["absolute", "relative", "relative"]} zIndex={"10"}  src='/images/plan/event.jpg' alt='rental' w={"full"} objectFit={"cover"} />
            <Flex pos={["relative", "relative", "absolute"]} insetX={"0px"} bottom={"0px"} pb={["6", "6", "0px"]} pt={["74px", "74px", "0px"]} top={["0px", "0px", "101.03px"]} gap={"8"} px={["6", "6", "16"]} flexDirection={["column", "column", "row"]} justifyContent={["center", "center", "space-between"]} alignItems={["start", "start", "center"]} zIndex={"30"} >
                <Flex w={"fit-content"} h={["fit-content", "fit-content", "80%"]} justifyContent={"center"} flexDir={"column"} gap={"4"} >
                    ...
                    <Text maxW={"481px"} fontSize={["42px", "42px", "60px"]} lineHeight={["120%", "120%", "75px"]} fontWeight={"700"} >Take control of your events with Chasescroll</Text>
                    <Text maxW={"481px"} fontWeight={"500"} >Explore a diverse range of events tailored to your interest and secure your spot with ease.</Text>
                    <CustomButton onClick={()=> push("/auth")} text={"Create Event"} px={"5"} width={"fit-content"} fontSize={"14px"} mt={"3"} borderRadius={"999px"} />
                </Flex>
