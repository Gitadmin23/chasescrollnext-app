            ...
            <Flex w={"full"} flexDir={"column"} alignItems={"center"} justifyContent={"center"} gap={["8", "8", "10"]} py={["10", "10px", "20"]} px={["6", "6", "12"]} >
                ...
                {!hide && (
                    <Flex w={"full"} display={["none", "none", "flex"]} pos={"relative"} h={["317px", "317px", "606px"]} justifyContent={"center"} alignItems={"center"} >
                        ...
                        <CustomButton text={"Sign-up"} width={"175px"} backgroundColor={[THEME?.COLORS?.chasescrollBlue, THEME?.COLORS?.chasescrollBlue, "white"]} height={"60px"} borderWidth={["0px", "0px", "1px"]} color={["white", "white", THEME?.COLORS?.chasescrollBlue]} borderRadius={"8px"} />
                    </Flex>
                )}
            </Flex>
