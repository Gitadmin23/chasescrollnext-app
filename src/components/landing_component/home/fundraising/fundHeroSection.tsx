...
export default function FundHeroSection() {
    return (
        ...
        <Flex w={"full"} h={["auto", "fit-content", "100vh"]} color={"white"} pos={"relative"} >
            ...
            <Image pos={["absolute", "relative", "relative"]} zIndex={"10"} src='/images/hero/fundraising.jpg' alt='fundraising' w={"full"} objectFit={"cover"} />
            <Flex pos={["relative", "relative", "absolute"]} insetX={"0px"} bottom={"0px"} pb={["6", "6", "0px"]} pt={["74px", "74px", "0px"]} top={["0px", "0px", "101.03px"]} gap={"8"} px={["6", "6", "16"]} flexDirection={["column", "column", "row"]} justifyContent={["center", "center", "start"]} zIndex={"30"} >
                ...
                <Flex maxW={"751px"} h={"fit-content"} mt={["0px", "0px", "6"]} position={"relative"} >
                    ...
                    <Image src='/images/plan/donationcard.png' alt='hero2' pos={"absolute"} left={"0px"} bottom={["0px", "0px", "0px"]} height={"50%"} objectFit={"contain"} />
                </Flex>
            </Flex>
        </Flex>
    )
