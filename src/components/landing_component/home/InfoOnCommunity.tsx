    ...
    return(
        <PictureAndText imageUrl="/images/hometwo.png" >
            <Flex p={"12"} gap={"6"} flexDir={"column"} >
                <Text fontSize={"32px"} lineHeight={"40px"} fontWeight={"semibold"} color={"#2B2D31"} >Build and Belong: Embrace Community on <span style={{ fontWeight: "bold", color: THEME?.COLORS?.chasescrollBlue }} >Chasescroll.</span></Text>
