        ...
        <Flex w={"full"} gap={"1"} mt={"2"} bg={mainBackgroundColor} flexDir={"column"} >
            ...
            <Flex pos={"relative"} w={"full"} gap={"1"}  bg={mainBackgroundColor} h={"fit-content"} alignItems={"start"} p={"2"} rounded={"12px"} >
                ...
                fontSize={"14px"}
                    ...
                    h={"45px"} w={"full"} bgColor={"#F2F3FB"} borderWidth={"0px"} _hover={{ borderWidth: "0px" }} focusBorderColor='transparent' color={"black"} placeholder='Comment' _placeholder={{ color: "#00000033" }} />
                {!replyData?.data?.id && (
