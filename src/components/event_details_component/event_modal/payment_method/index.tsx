...
function PaymentMethod(props: Props) {
    ...
    return (
        <Box width={"full"} bg={"white"} px={"8"} py={"10"} >
            ...
            <Flex onClick={()=> click((prev: any)=> prev + 1)} as='button' width={"full"} justifyContent={"start"} px={"4"} mt={"6"} borderColor={"#D0D4EB"} borderWidth={"1px"} gap={"3"} py={"8"} bg={"#F4F5FA"} rounded={"lg"} alignItems={"center"} >
                <DebitCardIcon />
