            ...
            {open && (
                <Flex zIndex={"110"} position={"absolute"} top={"0px"} flexDir={"column"} right={"0px"} maxW={"374px"} w={"full"} py={"4"} px={"6"} bg={"white"} rounded={'8px'} >
                    ...
                    <Flex as={"button"} onClick={()=> router.push("/dashboard/event/create_event")} w={"full"} py={"4"} mt={"8"} px={"2"} flexDir={"column"} rounded={"8px"} _hover={{borderColor: "#5D70F9"}} border={"1px"} borderColor={"transparent"} >
                        ...
                        <Text textAlign={"left"} color={"#626262"} mt={"2"} fontSize={"12px"} >As the event owner, you play a crucial role in decision making and receiving payments from attendees who buy tickets for this event.</Text>
                    </Flex>
