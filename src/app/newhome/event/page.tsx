    ...
    return (
        <Flex flexDir={"column"} w={"full"}  >
            ...
            <Flex px={["6", "6", "12"]} w={"full"} justifyContent={"space-between"} alignItems={"center"} py={"4"} >
                <Text color={"#2B2D31"} fontSize={["14px", "14px", "24px"]} lineHeight={["16.94px", "16.94px", "29.05px"]} fontWeight={"500"} >{event_category ? event_category?.replaceAll("_", " ") : "Upcoming Event"}</Text>
